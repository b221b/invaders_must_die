import pygame.font
from pygame.sprite import Group  # Добавьте этот импорт
from gun import Gun  # Добавьте импорт класса Gun
...
class Scores():
    ...
    def image_high_score(self):
        # преобразует рекорд в граф. изобр
    ...
    def image_guns(self):
        # кол-во жизней
        self.guns = Group()  # Теперь Group импортирован
    ...
    def show_score(self):
        ...
        self.guns.draw(self.screen)  # Исправлено: guns вместо gund
